...
$sql = "SELECT id, picture, category_name FROM product_categories";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo "<tr>";
        echo "<td><img src='../uploads/" . htmlspecialchars($row['picture']) . "' alt='Picture' class='img-thumbnail' width='50' height='50'></td>";
