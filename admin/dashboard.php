...
<main class="mt-5 pt-3">
    ...
    <div class="container-fluid">
        ...
        <!--Categories-->
        <div class="row mb-2 section-title">
            <div class="col-md-12 fw-bold fs-5">Products Categories</div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span class="table-title"><strong>Catergories</strong></span>
        ...
        <div class="modal fade" id="addCategory" tabindex="-1" aria-labelledby="addItemModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header text-white">
                        <h5 class="modal-title" id="addItemModalLabel">
                    ...
                    <div class="modal-body">
                        <form id="addItemForm" action="add_product_category.php" method="POST"
